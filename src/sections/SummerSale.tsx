...
const SummerSale = () => {
    return (
        <section className="relative mt-10 w-full bg-cover bg-center" style={{ backgroundImage: `url(${summerSale})` }}>
            <div className="pl-10 bg-slate-200 bg-opacity-60 lg:bg-opacity-20">
                <div className="container mx-auto space-y-6 flex flex-col items-center pb-20 pt-20 md:items-start">
                    ...
                    <p className="text-center text-gray-600 md:text-left w-[32rem]">Kup nasze smaczne ciasta i słodycze na następną imprezę lub rodzinny obiad w naszym sklepie internetowym i zaoszczędź więcej pieniędzy niż gdziekolwiek indziej.</p>
