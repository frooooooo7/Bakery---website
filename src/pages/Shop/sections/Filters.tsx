      ...
      <div className="container mx-auto">
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="w-full flex items-center justify-between">
            <button onClick={() => setSliderValue(rangeValue)} className='mt-2 px-4 lg:px-10 py-1 lg:py-5 bg-pink-700 text-white border-2 border-pink-800 rounded-lg font-bold active:bg-pink-500'>FILTRUJ</button>
